				...
				<div class="field-body">
					<table>
						<tr>
							...
							<td class="facility_data">${facility.name}</td>
						</tr>
						<tr>
							<td class="facility_labels">Franchiser:</td>
							<td class="facility_data">${facility.brand}</td>
						</tr>
						<tr>
							<td class="facility_labels">Owner:</td>
							<td class="facility_data">${facility.ownerName}</td>
						</tr>
						<tr>
							<td class="facility_labels">Address:</td>
							<td class="facility_data">${facility.address}</td>
						</tr>
						<tr>
							<td class="facility_labels">Phone Number:</td>
							<td class="facility_data">${facility.address.phone}</td>
						</tr>
						<tr>
							<td class="facility_labels">Email:</td>
							<td class="facility_data">${facility.address.email}</td>
						</tr>
						<tr>
							<td class="facility_labels">Website:</td>
							<td class="facility_data">${facility.address.url}</td>
						</tr>
						<tr>
							<td class="facility_labels">Site has trainers:</td>
							<td class="facility_data">${facility.hasTrainers}</td>
						</tr>
						<tr>
							<td class="facility_labels">Site open 24 hours:</td>
							<td class="facility_data">${facility.alwaysOpen}</td>
						</tr>
						<tr>
							<td class="facility_labels">Price:</td>
							<td class="facility_data">$${facility.price}</td>
						</tr>
					</table>
					<br>
				...
				<c:if test="${! empty facility.missionStatement}">
							...
							<div class="field-body">
								<table >
									...
									<tbody>
										<tr>
											<td>${facility.missionStatement}</td>
										</tr>
									</tbody>
								</table>
								<br> <br>
